...
export const scheduleItems: EventItem[] = [
  {
    ...
    description: "Fireside chat with Jenna Adler (CAA) and Jacqueline Saturn (Virgin Music Group).",
    startTime: "2026-03-28T09:10:00",
    endTime: "2026-03-28T09:55:00",
  },
  {
    title: "How Tours Get Green Lit",
    time: "10:00 – 10:40 AM",
    location: "Robertson",
    speaker: "Vinnie Ferra, Howard Handler",
    description: "How tours get green lit. Featuring Vinnie Ferra (The Beehive LA) and Howard Handler (313 Presents).",
  ...
  },
  {
    ...
    time: "10:55 – 11:35 AM",
    location: "Robertson",
    speaker: "Christian Hoard, Lydia Barry, Harrison Golding, Andrew Spelman, Tyler Eilenberg",
    description:
  ...
  },
  {
    ...
    location: "Robertson",
    speaker: "Alex Silverstein, Josh Housman, Andrew Batey, Peter Picado-Curtis",
    description:
      "Music as an asset class. Featuring Alex Silverstein (Too Lost), Josh Housman (Jefferies), Andrew Batey (Beatdapp), and Peter Picado-Curtis.",
  ...
  },
  {
    ...
    speaker: "",
    description: "Lunch & learn with recruitment-based rooms.",
  ...
  },
  {
    ...
    location: "Robertson",
    speaker: "Chris King",
    description: "Where brands meet music authentically. Chris King, CMS Nashville.",
    startTime: "2026-03-28T13:25:00",
    endTime: "2026-03-28T14:05:00",
  },
  {
    title: "From Sound to Strategy: Building Hits & Careers in Music",
    time: "2:10 – 2:50 PM",
    location: "Robertson",
    speaker: "Quinn XCII, ayokay, Gregg Latterman",
    description: "Building hits and careers in music with Quinn XCII, ayokay, and Gregg Latterman.",
  ...
  },
  {
    ...
    description: "Coffee chats and workshops. Moderated by Marie Jacobsen. Featuring Tony Scudellari, Sarah Bromberg, and Jongnic Bontemps.",
    startTime: "2026-03-28T15:05:00",
    endTime: "2026-03-28T16:05:00",
  },
  {
    title: "Fireside Chat with Leven Kali & Sol Was",
    time: "4:10 – 4:50 PM",
    location: "Robertson",
    speaker: "Leven Kali, Sol Was",
    description: "Fireside chat with Leven Kali and Sol Was.",
  ...
  },
  {
    ...
    description: "Discovering your calling in music with Brendon Anthony.",
...
export const speakerSessions: SpeakerSession[] = [
  ...
  },
  {
    ...
    speakers: [
      ...
      { name: "Jongnic Bontemps", role: "Composer and Musician, Sony Pictures Television" },
      { name: "Marie Jacobsen", role: "Executive VP, Head of Current Programming, Sony Pictures Television", isModerator: true },
    ],
  },
  {
    title: "Fireside Chat with Leven Kali & Sol Was",
